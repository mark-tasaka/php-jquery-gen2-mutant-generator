...
<html>
<head>
<title>Launch Page: MCC Mutant Character Generator</title>
...
<body>
	...
	<section>
		...
		<h1><img src="images/title.png" alt="Mutant Character Generator" class="image" /></h1>
		...
		<form action="" id ="mutantForm2"  target="_blank" method="post">
            ...
            <span class="formIputDescription">Archaic Alignment:</span>	
			  <select id="archaicAlignment" name="theArchaicAlignment" class="alignmentBox">			
				...
				<option value="The Curators">Children of the Glow</option>
			  </select>
        ...
        $("#generate_characters2").click(function(){
            ...
            $("#mutantForm2").attr('action', "character2/mcc_mutant_"+ $("#level").val() + $("#abilityScores").val() +  $("#mutations").val() + ".php");
        });
